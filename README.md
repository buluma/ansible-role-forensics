...
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-forensics/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-forensics/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-forensics.svg)](https://github.com/buluma/ansible-role-forensics/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-forensics.svg)](https://github.com/buluma/ansible-role-forensics/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-forensics.svg)](https://github.com/buluma/ansible-role-forensics/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/forensics)](https://galaxy.ansible.com/ui/standalone/roles/buluma/forensics/documentation)|
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-forensics/issues).
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-forensics/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-forensics
